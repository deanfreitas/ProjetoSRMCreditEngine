...
**O que ficou de fora.** Não há métrica de cobertura no build — nem JaCoCo, nem *gate* de percentual. São **98 invocações** (`mvn test`, confirmado nos relatórios do surefire: 98 testes, 0 falhas, 0 erros, 0 ignorados), distribuídas por decisão e não por arquivo.
